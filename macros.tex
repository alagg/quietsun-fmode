...
\newcommand{\al}[1]{{\color{al}#1}}
\newcommand{\mk}[1]{{\color{mvn}#1}}
\newcommand{\no}[1]{{\color{corr}#1}}
\newcommand{\ns}[1]{\textsc{\color{al}#1}} 
\newcommand{\hr}[1]{\textbf{\color{ref}#1}} 
\newcommand{\todo}[1]{{\color{cmt}#1}}
