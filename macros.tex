...
\newcommand{\brms}{$B_{\rm rms}$}
%AL changed the macro to avoid a space in front of e.g. a comma
%MJK there is already a no space macro
\newcommand{\fff}{$f$-mode\;}
%\newcommand{\fff}{$f$-mode}
\newcommand{\fffns}{$f$-mode}
\newcommand{\ef}{$E_f$}
\newcommand{\eft}{$\tilde{E_f}$}
\newcommand{\mef}{E_f}
\newcommand{\meft}{\tilde{E_f}}
