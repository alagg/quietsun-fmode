...
in advance where ARs are going to emerge later. In an observational study involving
...
important applications for early forecasting of the space weather. These could also shed light
...
\colfigtwocol{butterfly_lat_FFOV_KX0}{Same as \fig{butterfly_lat}, computed from a wedge of $\pm10^\circ$ around the $k_y$ axis, representing the poloidal component.}

\colfigtwocol{butterfly_lat_FFOV_KY0}{Same as \fig{butterfly_lat}, computed from a wedge of $\pm10^\circ$ around the $k_x$ axis, representing the toroidal component.} 

%NS: added following for butterfly-figure
\Fig{butterfly_lat} displays the butterfly diagram of the quiet-Sun $f$-mode power determined
...
\colfig{AR11130_track}{$f$-mode strength of AR11130.}
\colfig{AR11105_track}{$f$-mode strength of AR11130.}
%AL
