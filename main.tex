...
environment, we had collected a total of \todo{18327 number to be updated for final version!} \fff 
%powers 
energies
...
This correction $A_{\mbox{corr}}(\lambda)$ is then subtracted from the computed \fff power, which efficiently removes any yearly variation. 
