...
\begin{figure}\centering
	\includegraphics[width=1.0\linewidth,clip=TRUE]{ring_diagram}\\
	\includegraphics[width=1.0\linewidth,clip=TRUE]{az_avg_spec}
	\caption{Top: example of the quiet sun ring diagram at $\nu=$. Bottom: spectrum obtained by azimuthally averaging the ring diagram. The red vertical line marks the position of the maximum of the $f$-mode and the black vertical lines the range of integration.}
	\label{ring_diagram}
\end{figure}
