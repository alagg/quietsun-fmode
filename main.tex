...
%MJK
%AL comment:
%My definition is maybe poor. What do you mean with $f'_{P, {\rm rms}}$? Is it the rms of $f'_{P}$ computed over the solar cycle? This is not what I wanted to define.
