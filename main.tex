...
%MJK
\Fig{butkx0} shows the butterfly near the $k_x$=0 axis, tracing f-mode sensitivity on the poloidal component of the
magnetic field, and \Fig{butky0} the same near the $k_y$=0 axis,
tracing the sensitivity to the toroidal field. Interestingly,
