...
\colfigtwocol{butterfly_lat_KX0}{Same as \fig{butterfly_lat}, computed from a wedge of $\pm10^\circ$ around the $k_y$ axis, representing the poloidal component.}. 

\colfigtwocol{butterfly_lat_KY0}{Same as \fig{butterfly_lat}, computed from a wedge of $\pm10^\circ$ around the $k_x$ axis, representing the toroidal component.}. 
