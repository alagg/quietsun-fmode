...
$\overline{f}(\lambda) = 1/N_t \sum_t f(\lambda,t)$ = $f$-mode strength (in lat / time bins) averaged over time, \\
$\overline{f_P}(\lambda) = 1/N_t \sum_t f_P(\lambda,t)$ = $f$-mode strength (in lat / time bins) averaged over time, \\
...
\begin{equation}
\sigma^2_{\mbox{cyc}}(\lambda) = \frac{1}{N_t} \sum_{t} \left( f_P(\lambda,t) -\overline{f_P}(\lambda)\right)^2
\end{equation}
...
\colfig{butterfly_lat}{Butterfly diagram of $f$-mode strength.}
